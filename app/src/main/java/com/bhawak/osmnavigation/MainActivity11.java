...
////                .build();
////        MapboxNavigation mp = new MapboxNavigation(this,"pk.xxx",options);
////        MapboxNavigationOptions.Builder mb = MapboxNavigationOptions.builder();
//
//        NavigationLauncherOptions.Builder optionsBuilder = NavigationLauncherOptions.builder()
//                .shouldSimulateRoute(false)
//                .waynameChipEnabled(false);
//        optionsBuilder.directionsRoute(currentRoute);
////        NavigationMapRoute mapRoute = new NavigationMapRoute(mp, mapView, mapboxMap, R.style.NavigationMapRoute ) ;
...
//        mapboxMap.setStyle(new Style.Builder().fromUri("http://178.128.59.143:8080/api/v2/styles/a1e37ae99cdb4f29910cdf27a51a0282.json"), new Style.OnStyleLoaded() {
//            @Override
