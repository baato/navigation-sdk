...
public final class CrashReportBuilder {
  ...
  public static CrashReportBuilder setup(Context context, String sdkIdentifier, String sdkVersion,
                                         Set<String> allowedStacktracePrefixes) {
  ...
  public CrashReportBuilder addCausalChain(@NonNull List<Throwable> causalChain) {
    this.causalChain.addAll(causalChain);
    return this;
  }

  public CrashReportBuilder addExceptionThread(@Nullable Thread thread) {
