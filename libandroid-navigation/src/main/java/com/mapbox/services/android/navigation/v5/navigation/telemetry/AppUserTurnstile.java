...
import static com.mapbox.services.android.navigation.v5.navigation.telemetry.TelemetryEnabler.TELEMETRY_STATES;
...
public class AppUserTurnstile extends Event implements Parcelable {
  ...
  public static final Creator<AppUserTurnstile> CREATOR = new Creator<AppUserTurnstile>() {
    @Override
