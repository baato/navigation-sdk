...
public class NavigationMapboxMap {
   ...
   * {@link androidx.core.app.FragmentActivity#onSaveInstanceState(Bundle, PersistableBundle)}.
   * <p>
   ...
   * <p>
   * This cannot be called in {@link androidx.core.app.FragmentActivity#onRestoreInstanceState(Bundle)}
